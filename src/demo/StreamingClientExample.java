...
public class StreamingClientExample {
	...
	private static final String USER_NAME = "scottpersinger@gmail.com";
	private static final String PASSWORD = "101monkeyswNRPJF0vgZAWcaI83nqmt9ngc";
	...
	private static final String CHANNEL = "/topic/cm.Contact";
	...
	public static void main(String[] args) throws Exception {
		...
		client.getChannel(ClientSessionChannel.META_HANDSHAKE).addListener
		...
		client.getChannel(ClientSessionChannel.META_CONNECT).addListener(
				new ClientSessionChannel.MessageListener() {
					public void onMessage(ClientSessionChannel channel, Message message) {
		...
		client.getChannel(ClientSessionChannel.META_SUBSCRIBE).addListener(
				new ClientSessionChannel.MessageListener() {
					public void onMessage(ClientSessionChannel channel, Message message) {
